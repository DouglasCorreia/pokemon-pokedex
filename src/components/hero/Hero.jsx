...
function Hero (props) {
    return(
        <>
            <div className='min-h-[560px] bg-gradient-to-r from-red-500 via-thunderbird-800 to-thunderbird-800 flex flex-col justify-center items-center relative px-4'>
